...
// The headless-gl library fails to install on the ewi gitlab CI servers,
// because some packages are missing. I'm not testing this for now, 
// but integration testing using selnium would certainly be an option.
